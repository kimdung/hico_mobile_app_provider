...
class PrescriptionsApi {
  ...
  Future<Response<BuiltList<PrescriptionSummaryDtos>>> apiPrescriptionsGet({ 
    ...
    final _path = r'/api/Prescriptions';
    ...
    return Response<BuiltList<PrescriptionSummaryDtos>>(
      data: _responseData,
  ...
  Future<Response<PrescriptionDetailDtos>> apiPrescriptionsIDGet({ 
    ...
    PrescriptionDetailDtos _responseData;

    try {
      const _responseType = FullType(PrescriptionDetailDtos);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<PrescriptionDetailDtos>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
