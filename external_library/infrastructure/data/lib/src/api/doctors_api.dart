...
class DoctorsApi {
  ...
  Future<Response<BuiltList<DoctorSummaryDtos>>> apiDoctorsGet({ 
    ...
    BuiltList<DoctorSummaryDtos> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(DoctorSummaryDtos)]);
    ...
    return Response<BuiltList<DoctorSummaryDtos>>(
      data: _responseData,
  ...
  Future<Response<DoctorSummaryDtos>> apiDoctorsIDGet({ 
    ...
    final _path = r'/api/Doctors/{ID}'.replaceAll('{' r'ID' '}', ID.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    DoctorSummaryDtos _responseData;

    try {
      const _responseType = FullType(DoctorSummaryDtos);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<DoctorSummaryDtos>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
