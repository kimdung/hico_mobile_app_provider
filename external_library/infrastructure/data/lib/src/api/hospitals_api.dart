...
class HospitalsApi {
  ...
  Future<Response<BuiltList<HospitalSummaryDtos>>> apiHospitalsGet({ 
    ...
    return Response<BuiltList<HospitalSummaryDtos>>(
      data: _responseData,
  ...
  Future<Response<HospitalSummaryDtos>> apiHospitalsIDGet({ 
    ...
    HospitalSummaryDtos _responseData;

    try {
      const _responseType = FullType(HospitalSummaryDtos);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<HospitalSummaryDtos>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
