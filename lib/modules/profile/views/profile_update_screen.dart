                        ...
                        child: Form(
                          ...
                          child: Column(
                            children: [
                              //name
                              _buildLabel(
                                  title: 'support.name'.tr, required: 1),
                              const SizedBox(height: 8),
                              _buildInputFullname(),
                              //gender
                              ...
                              const SizedBox(height: 14),
                              _buildLabel(
                                  title: 'support.phone'.tr, required: 1),
                              const SizedBox(height: 8),
                              _buildInputPhone(),
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    _buildInputTextArea(
                                        ...
                                        title:
                                            'profile.update.address_block'.tr),
                                  ],
                                ),
                              ),
                                    ...
                                    Expanded(
                                      child: _buildImageItem(
                                        ...
                                        current_image: controller
                                            ...
                                            '',
                                        file:
                                            controller.documentFrontSide.value,
                                        onPress: () {
                                          controller
